...
class Container_95b8329997 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\Survey\SurveyPresenter' => [2 => ['application.4']],
		'App\UI\Result\ResultPresenter' => [2 => ['application.5']],
	...
	public function createService02(): App\Model\SurveyRepository
	{
		return new App\Model\SurveyRepository($this->getService('database.default.explorer'));
	}
	...
	public function createServiceApplication__4(): App\UI\Survey\SurveyPresenter
	{
		$service = new App\UI\Survey\SurveyPresenter($this->getService('02'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__5(): App\UI\Result\ResultPresenter
	{
		$service = new App\UI\Result\ResultPresenter(
			$this->getService('02'),
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=db;dbname=nette_db',
			/*sensitive{*/'nette_user'/*}*/,
			/*sensitive{*/'secret'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_95b8329997 $container,
			) {
			}
